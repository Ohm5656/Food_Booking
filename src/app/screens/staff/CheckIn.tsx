  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] pb-24">
      ...
      <header className="bg-white px-5 pt-4 pb-4 border-b border-slate-100 sticky top-0 z-40 shadow-sm">
        <h1 className="text-xl font-bold text-slate-800 mb-4">เช็กอินลูกค้า</h1>
        ...
        <div className="flex gap-3 mb-4">
          <button
            ...
            className={clsx(
              "flex-1 py-3 rounded-xl font-semibold transition-all flex items-center justify-center",
              scanMode
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full bg-slate-50 border border-slate-200 rounded-xl py-3 pl-10 pr-4 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
          />
        </div>
      </header>
